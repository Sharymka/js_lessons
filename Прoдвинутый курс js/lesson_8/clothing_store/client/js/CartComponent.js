...
export default Vue.component("cart", {
  ...
  template: `
  <li class="header-nav-item mobile-display header-cart" >
    <a href="#">
      <svg @click="showCart=!showCart"
        width="32"
        height="29"
        viewBox="0 0 32 29"
    ...
    <input class="count_items" type="text" name="counter" :value="counter" />

    <div class="items-list" v-show="showCart">
        <cart-item 
