    ...
    addProduct(product) {
      ...
      this.cart.forEach((el, i) => {
        ...
        if (el.id_product === product.id_product) {
          currentProduct = el;
          index = i;
          newElement = Object.assign({}, el, {
            quantity: el.quantity + 1,
          });
          newElement.totalPrice = newElement.quantity * newElement.price;
        }
      });
      if (newElement) {
        console.log("I want to add new element ", newElement);
        this.cart.splice(index, 1, newElement);
      }
      if (currentProduct === null) {
        this.cart.push(
          Object.assign(product, { quantity: 1, totalPrice: product.price })
        );
      }
    },
